...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		lblCheckIn.setBounds(72, 138, 196, 14);
		...
		lblCheckOut.setBounds(72, 223, 196, 14);
		...
		lblValor.setBounds(72, 308, 196, 14);
	...
	private void guardarReserva() {	
		...
		double doubleValor = Double.parseDouble(txtValor.getText());
		Reserva nuevaReserva = new Reserva(java.sql.Date.valueOf(fechaE), java.sql.Date.valueOf(fechaS),doubleValor,txtFormaPago.getSelectedItem().toString());
	...
	private void calcularValor(JDateChooser fechaE,JDateChooser fechaS) {		
		if(fechaE.getDate() != null && fechaS.getDate() !=null) {
			...
			txtValor.setBounds(78, 328, 123, 33);
			txtValor.setHorizontalAlignment (SwingConstants.CENTER); 
